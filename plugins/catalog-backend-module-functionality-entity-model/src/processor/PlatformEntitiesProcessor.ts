...
import { PlatformEntityV1alpha1, platformEntityV1alpha1Validator } from '@internal/backstage-plugin-functionality-common';
...
export class PlatformEntitiesProcessor implements CatalogProcessor {
  ...
  async postProcessEntity(
    ...
    if (
      ...
      const platform = entity as PlatformEntityV1alpha1;
